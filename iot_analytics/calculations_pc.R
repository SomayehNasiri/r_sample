...
daily_consumption_c <- inner_join( sub_meter1_d,sub_meter2_d, by = "date_col",suffix = c("dmeter1", "dmeter2"))
daily_consumption_c2 <- inner_join( sub_meter3_d,sub_metert_d, by = "date_col",suffix = c("dmeter3", "dmetert"))
